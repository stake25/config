...
Cypress.Commands.add('routeClosing_updateServiceCode', (sequence: number, serviceCode: string) => {
  cy.intercept('PUT', `**routes/v2/divisions/**/routes/**/active/stops/**`).as('updateServiceCode');
