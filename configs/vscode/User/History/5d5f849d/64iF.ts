  ...
  it(
    ...
    function () {
      ...
      cy.get(breaksTable).within(() => {
        cy.get('tbody').should('be.visible');
        cy.get(breakStart).clear();
        cy.get(breakStart).type(this.testCaseData.startTime7);

        cy.get(breakFinish).clear();
        cy.get(breakFinish).type(this.testCaseData.finishTime7);
      });
      ...
      // And I fill the Break with Start Time "06:01" And Finish Time "20:12"
      cy.log('And I fill the Break with Start Time "06:01" And Finish Time "20:12"');
      cy.get(breaksTable).within(() => {
        cy.get('tbody').should('be.visible');
        cy.get(breakStart).clear();
        cy.get(breakStart).type(this.testCaseData.startTime6);

        cy.get(breakFinish).clear();
        cy.get(breakFinish).type(this.testCaseData.finishTime6);
      });
      ...
      // And I fill the Break with Start Time "07:55" And Finish Time "07:45"
      cy.log('And I fill the Break with Start Time "07:55" And Finish Time "07:45"');
      cy.get(breaksTable).within(() => {
        cy.get('tbody').should('be.visible');
        cy.get(breakStart).clear();
        cy.get(breakStart).type(this.testCaseData.startTime5);

        cy.get(breakFinish).clear();
        cy.get(breakFinish).type(this.testCaseData.finishTime5);
      });
