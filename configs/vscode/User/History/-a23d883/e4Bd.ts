...
declare namespace Cypress {
  interface Chainable {
     ...
     * @example cy.generateDBQueryDate('16');
     */
    ...
    /**
     * A command to filter the routes in the table by the route number on the route closing page
     * @param {string} routeNumber:
     * @example cy.routeClosing_filterRouteByNum('4127');
     */
    routeClosing_filterRouteByNum(routeNumber: string): void;
